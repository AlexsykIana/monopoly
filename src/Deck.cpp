...
void Deck::initializeChanceDeck() {
    ...
    cards.emplace_back("Go to Jail. Go directly to Jail. Do not pass Go, do not collect $200",
                       Card::ActionType::GO_TO_JAIL);
    cards.emplace_back("Bank pays you dividend of $50", Card::ActionType::RECEIVE_MONEY_FROM_BANK, 50);
    cards.emplace_back("Get out of Jail Free. This card may be kept until needed or sold.",
                       Card::ActionType::GET_OUT_OF_JAIL_FREE, 0, 0, true);
